...
export default function CommunityPageEditorPage() {
  const [, routeParams] = useRoute('/admin/pages/community/:id/edit');
  const [, newParams] = useRoute('/admin/pages/community/new');
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: (data, variables) => {
      ...
      if (isNew && savedPage.id) {
        setLocation(`/admin/pages/community/${savedPage.id}/edit`);
      }
    },
    onError: (error: Error) => {
      toast({
