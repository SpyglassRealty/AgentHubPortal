  ...
  return (
    <Layout>
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        {/* Market Pulse with Spyglass Listings and Action Items - Side by Side on Desktop */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Combined Market Pulse + Spyglass Listings - Takes 2 columns on desktop */}
          <div className="lg:col-span-2">
            <MarketPulseWithSpyglassListings />
          </div>

          {/* Action Items Card - Takes 1 column on desktop */}
          {suggestionsLoading ? (
