...
// Using available Spyglass logos - will need to be updated with actual LRE SGR logos
const lreSgrWhiteLogo = '/spyglass-logo.png';
const lreSgrBlackLogo = '/spyglass-logo.png';
import {
  extractPrice,
  extractSqft,
  extractDOM,
