// Re-export from utils/status-colors for compatibility
export { getStatusConfig, getStatusBadgeStyle, getStatusColor as getStatusColorUtil, getDaysRemainingStyle, getStatusLabel } from './utils/status-colors';
export type { StatusConfig } from './utils/status-colors';
