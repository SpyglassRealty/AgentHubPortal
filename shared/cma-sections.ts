// CMA Report Section configuration
// Icons are referenced by string identifiers (not lucide-react imports)
// to stay framework-agnostic across Mission Control and Contract Conduit
...
export interface CmaSectionConfig {
  ...
  icon: string; // Icon identifier (e.g., 'FileText', 'Home', 'BarChart3')
  editable?: boolean;
}
